window.jwplayer = function (e) {
            ...
            d = !(u || c && i.isMobile()), f = i.isFF() && i.isOSX(), p = function (e, t) {
                ...
                function v(e) {
                    ...
                    if (A) y(l.DRAG, e); else {
                        var i = r(e, "X"), o = r(e, "Y"), a = i - k, u = o - C;
                ...
                var w, E, b = e, A = !1, k = 0, C = 0, L = 0, P = 300;
    ...
    var i, r;
    i = [], r = function () {
        return "7.12.0+commercial_v7-12-0.185.commercial.41a0cf.jwplayer.f4cf97.freewheel.a63b67.googima.dc161b.vast.67ee7c.analytics.212a6c.plugin-gapro.7e936b.plugin-related.7adae3.plugin-sharing.09736f.vr-plugin.d532d3.hls.js.";
    }.apply(t, i), !(void 0 !== r && (e.exports = r))
}, function (e, t, n) {
    var i, r;
    ...
    r = [n(89), n(96), n(1), n(92), n(93), n(33), n(101), n(53), n(52), n(2), n(81), n(3), n(34), n(5), n(4), n(141), n(95)], o = function (e, t, n, i, r, o, s, u, c, d, f, p, h, g, v, m, y) {
        ...
        return b.prototype = {
            ...
            setup: function (o, m) {
                ...
                function b(e, t) {
                    ge.trigger(v.JWPLAYER_CONTROLS, {controls: t})
                }
                ...
                function k() {
                    fe.change("visibility", C), fe.on("change:controls", b), ge.trigger(v.JWPLAYER_READY, {setupTime: 0}), ge.triggerAfterReady = ge.trigger;
                ...
                function P(e, t) {
                    ge.trigger("viewable", {viewable: t}), j(e, t)
                }

                function j(e, t) {
                    fe.get("playOnViewable") && (t ? O() : d.isMobile() && ge.pause({reason: "autostart"}))
                }

                function _(e) {
                    var t = fe.getProviders(), n = t.required(e, fe.get("primary"));
                ...
                function R() {
                    for (; ge.eventsQueue.length > 0;) {
                        var e = ge.eventsQueue.shift(), t = e[0], n = e[1] || [];
                        ge["_" + t].apply(ge, n)
                    }
                }
                ...
                function M() {
                    ...
                    if (fe.set("playReason", e.reason), fe.get("state") !== g.ERROR) {
                        ...
                        if (fe.get("state") === g.COMPLETE && (D(!0), B(0)), !pe && (pe = !0, ge.triggerAfterReady(v.JWPLAYER_MEDIA_BEFOREPLAY, {playReason: fe.get("playReason")}), pe = !1, de)) return de = !1, void(ce = null);
                        var i;
                        if (Y()) {
                ...
                function O() {
                    var e = fe.get("state");
                    e !== g.IDLE && e !== g.PAUSED || M({reason: "autostart"})
                }
                ...
                function J(e, t) {
                    fe.set("feedData", t);
                    var i = u(e);
                    return i = u.filterPlaylist(i, fe, t), fe.set("playlist", i), n.isArray(i) && 0 !== i.length ? (_(i), !0) : (ge.triggerError({message: "Error loading playlist: No playable sources found"}), !1)
                }
                ...
                function H() {
                    if (Y()) {
                        ...
                        ce = H;
                        var e = fe.get("item");
                        return e === fe.get("playlist").length - 1 ? void(fe.get("repeat") ? U({reason: "repeat"}) : (d.isIOS() && oe(!1), fe.set("playOnViewable", !1), fe.set("state", g.COMPLETE), ge.trigger(v.JWPLAYER_PLAYLIST_COMPLETE, {}))) : void U({reason: "playlist"})
                    }
                }
                ...
                var se, le, ue, ce, de, fe = this._model, pe = !1, he = !1, ge = this, ve = function () {
                    return fe.getVideo()
                }, me = new s;
                me.track(fe);
                var ye = new e(o, me), we = [];
                fe.setup(ye, me), se = this._view = new f(m, fe), ue = new i(m, fe, se, J), ue.on(v.JWPLAYER_READY, A, this), ue.on(v.JWPLAYER_SETUP_ERROR, this.setupError, this), fe.mediaController.on("all", w, this), fe.mediaController.on(v.JWPLAYER_MEDIA_COMPLETE, function () {
                    ...
                    ge.trigger(v.JWPLAYER_FULLSCREEN, {fullscreen: t}), t && e.set("playOnViewable", !1)
                    ...
                    if (t.length) {
                        var i = {playlist: t}, r = fe.get("feedData");
                        if (r) {
                            var o = n.extend({}, r);
                    ...
                    ge.trigger(v.JWPLAYER_MEDIA_VOLUME, {volume: t})
                }), fe.on("change:mute", function (e, t) {
                    ge.trigger(v.JWPLAYER_MEDIA_MUTE, {mute: t})
                }), fe.on("change:playbackRate", function (e, t) {
                    ge.trigger(v.JWPLAYER_PLAYBACK_RATE_CHANGED, {playbackRate: t, position: e.get("position")})
                }), fe.on("change:scrubbing", function (e, t) {
                    t ? N() : M({reason: "interaction"})
                }), fe.on("change:captionsList", function (e, t) {
                    ge.triggerAfterReady(v.JWPLAYER_CAPTIONS_LIST, {tracks: t, track: fe.get("captionsIndex") || 0})
    ...
    i = [n(98), n(97), n(4), n(5), n(2), n(3), n(1)], r = function (e, t, n, i, r, o, a) {
        ...
        var l = {skipoffset: null, tag: null}, u = function (e, o, u) {
            ...
            var h, g, v, m, y, w = s(o), E = new w(e, o), b = 0, A = {}, k = this, C = a.bind(function (e) {
            ...
            this.loadItem = function (e, i) {
                ...
                var u = o.getProviders(), c = w === t ? "flash" : void 0, d = u.required(s, c);
    ...
    r = [n(4), n(5), n(3), n(2), n(1), n(149), n(148), n(147), n(120), n(142), n(143), n(144), n(50)], o = function (e, t, i, r, o, a, u, d, p, y, w, E, b) {
        function A(A, _) {
            ...
            function K(e, t) {
                r.toggleClass(e, "jw-flag-fullscreen", t), k(document.body, {overflowY: t ? "hidden" : ""}), t && Ee && Ee.userActive(), z(), x()
            }
            ...
            var re = r.createElement((0, s["default"])(_.get("id"), _.get("localization").player)),
                oe = re.querySelector(".jw-media"), ae = new w(_), se = new E(_), le = new p(_), ue = void 0,
                ce = void 0, de = void 0, fe = void 0, pe = void 0, he = -1, ge = -1, ve = void 0, me = void 0,
                ye = void 0, we = null, Ee = void 0;
            this.updateBounds = function () {
                (0, g.cancelAnimationFrame)(ge);
                var e = document.body.contains(re), t = C(re), n = Math.round(t.width), i = Math.round(t.height);
        ...
        var k = r.style, C = r.bounds, L = r.isMobile(), P = r.isIE(), j = !1;
